You have access to vercel cli to debug deployments and logs and any other vercel commands anytime you want
You have access to gh cli tool to look up github actions and anything else anytime you want
In the UX we are going to brand our terminology to Symploke, like Plexus (team), Weave (connection)
